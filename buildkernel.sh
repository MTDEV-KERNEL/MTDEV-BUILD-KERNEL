###################################################
#build.sh -                                       #
#Shell script to build the kernel CM9 for         #
#the Motorola Triumph and zip it into a CWM       #
#flashable package                                #
#                                                 #
#Written by shane87                               #
#Modified by b_randon14                           #
#Heavily modified by mantera                      #
#Extra modifications by g60madman		  #
###################################################
...
export WORKDIR=/media/android/MTDEV-BUILD-KERNEL

#The kernel source directory
export KERNELDIR=/media/android/MTDEV-BUILD-KERNEL/kernel/
...
then
	echo "Copying config to .config"
        cp $KERNELDIR/config $KERNELDIR/.config
fi
